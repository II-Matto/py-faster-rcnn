...
class my_facedb(datasets.imdb):
    ...
    def _load_image_set_index(self):
        ...
        #                              self._image_set + '.txt')
        image_set_file = os.path.join(self._data_path, 'image.txt');
    ...
    def _load_face_annotation(self, index):
        ...
        format.
        """
        filename = os.path.join(self._data_path, index + '_frcn.txt')
        # print 'Loading: {}'.format(filename)
    ...
    def _write_results_file(self, all_boxes):
        ...
        for cls_ind, cls in enumerate(self.classes):
            ...
            print 'Writing detection result file: {}'.format(cls)
